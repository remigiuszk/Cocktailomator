...
public class FavouriteCocktail {
    ...
    public FavouriteCocktail() {
    }

    public FavouriteCocktail(String strDrink, String strCategory, String strAlcoholic, String strGlass, String strInstructions, String strDrinkThumb,
